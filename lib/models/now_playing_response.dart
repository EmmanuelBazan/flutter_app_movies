...
class NowPlayingResponse {
  ...
  // CONVIERTE UNA RESPUESTA JSON EN UNA INSTANCIA DE NUESTRA CLASE
  ...
  // CONVIERTE LA INSTANCIA DE NUESTRA CLASE EN MAP PARA SER ENVIADO COMO REQUEST EN UNA PETICION HTTP
